...
openssl req -new -batch -out mme.csr.pem -key /etc/open5gs/tls/mme.key.pem -subj /CN=mme.epc.mnc001.mcc001.3gppnetwork.org/C=KO/ST=Seoul/L=Nowon/O=Open5GS/OU=Tests
